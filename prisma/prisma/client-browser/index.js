...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/fabxdev/medium-backend/mdm-backend/prisma/prisma/client-browser",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"@prisma/client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\ngenerator client_browser {\n  provider = \"prisma-client-js\"\n  output   = \"./prisma/client-browser\"\n}\n\nmodel User {\n  id       String  @id @default(uuid())\n  email    String  @unique\n  name     String?\n  password String\n  posts    Post[]\n}\n\nmodel Post {\n  id        String  @id @default(uuid())\n  title     String\n  content   String\n  published Boolean @default(false)\n  author    User    @relation(fields: [authorId], references: [id])\n  authorId  String\n}\n",
  "inlineSchemaHash": "c10dad8b1dd60d3ae54b01ac7183ea7374db4d677750d6c80309f24cecd530ac",
  "copyEngine": false
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/prisma/client-browser",
    "prisma/client-browser",
  ]
